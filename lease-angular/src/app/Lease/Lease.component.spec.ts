...
describe('LeaseComponent', () => {
  ...
  let mockLeaseService;
  let mockDataService

  beforeEach(async(() => {

    mockLeaseService = sinon.createStubInstance(LeaseService);
    mockLeaseService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: LeaseService, useValue: mockLeaseService },
