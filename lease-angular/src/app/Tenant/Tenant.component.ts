...
export class TenantComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceTenant.getAll()
    .toPromise()
    .then((result) => {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.markn.mynetwork.Tenant',
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.serviceTenant.deleteParticipant(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceTenant.getparticipant(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
      ...
      if (result.tenantId) {
        formObject.tenantId = result.tenantId;
      } else {
        formObject.tenantId = null;
      }
      ...
      if (result.idNo) {
        formObject.idNo = result.idNo;
      } else {
        formObject.idNo = null;
      }
